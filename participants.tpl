{assign var="pageTitle" value="Participants"}
{assign var="small_page" value="true"}
{assign var="rightcol_on" value="true"}
{assign var="rightcol_image" value="provo.jpg"}
...
<div class="white">
	...
	<div class="row-fluid">
		<div class="span4">
				...
				<ul class="unstyled">
					<li>Dawn Bastian Paschal</li>
					<li>Assistant Dean for Digital Library &amp; ePublishing Services </li>
					<li>Morgan Library</li>
					<li>Colorado State University</li>
					<li>Fort Collins, CO 80523-1019</li>
					<li><a href="mailto:dawn.paschal@colostate.edu">dawn.paschal@colostate.edu</a></li>
					<li>970-491-1849</li>
				</ul>
		</div>
		<div class="span4">
				...
				<ul class="unstyled">
					<li>Greg Thompson</li>
					<li>Assoc. Director for Special Collections</li>
					<li>Special Collections</li>
					<li>J. W. Marriott Library</li>
					<li>295 S. 1500 East</li>
					<li>Salt Lake City , UT      84112-0860</li>
					<li><a href="mailto:greg.c.thompson@utah.edu">greg.c.thompson@utah.edu</a> </li>
					<li>801-581-8046</li>
				</ul>
		</div>
		<div class="span4">
				...
				<ul class="unstyled">
					<li>Cory Nimer</li>
					<li>Manuscript Cataloger and Metadata Specialist</li>
					<li>L. Tom Perry Special      Collections</li>
					<li>Brigham Young University</li>
					<li>Provo , UT 84602</li>
					<li>Office: 1108 HBLL </li>
			...
			<div class="span4">
				...
				<ul class="unstyled">
					<li>Linda Vida</li>
					<li>Director</li>
					<li>Water Recources Center Archives</li>
					<li>University of California, Riverside</li>
					<li><a href="mailto:lvida@ucr.edu">lvida@ucr.edu</a></li>
					<li>951-827-2934</li>
				</ul>
			</div>
			<div class="span4">
				...
				<ul class="unstyled">
					<li>Alex Merrill</li>
					<li>Systems/Operations Manager &amp; Digital Initiatives Librarian</li>
					<li>Terrell Library Washington State University</li>
					<li><a href="mailto:merrilla@wsu.edu">merrilla@wsu.edu</a></li>
					<li>509-335-5426</li>
				</ul>
			</div>
			<div class="span4">
			...
			<div class="span4">
				...
				<div class="span4">
					...
					<div class="span4">
						...
						University of New Mexico, Albuquerque NM 87131</p>
					</div>
					</div>
					<div class="row-fluid">
					<div class="span4">
					...
					<div class="span4">
						...
						295 S. 1500 East<br />
						Salt Lake City, UT  84112-0860</p>
					</div>
					<div class="span4">
						<strong>University of Washington</strong>
						<p>University of Washington<br />
						Box 352900<br />
						Seattle , WA 98195-2900</p>
					</div>
					<div class="span4">
						<strong>Washington State University</strong>
						<p>Digital Services/Collections<br />
						New Library 1G<br />
						Pullman , WA 99164-5610</p>
					</div>
					</div>
						</div>
						<div id="tabs5-pane3" class="tab-pane fade in">
						<h3>All Participants</h3>
							 <div class="row-fluid">
						  <div class="span4">
							<p><strong>GWLA Content Contributing Institutions:</strong></p>
			<ul>
				<li><a target="_blank" href="http://www.asu.edu/">Arizona State University</a></li>
				...
				<li><a target="_blank" href="http://www.wsu.edu/">Washington State University</a></li>
			</ul>
			</div>
			<div class="span4">
		  <p><strong>Non-GWLA Content Contributors:</strong></p>
			...
			<div class="span4">
		  <p><strong>Other GWLA Members:  </strong></p>
			<ul>
