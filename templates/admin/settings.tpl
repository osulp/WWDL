...
{/if}
	<tr valign="top">
		<td width="20%"   >{fieldLabel name="title" key="admin.settings.siteTitle" required="true"}</td>
	...
	<tr valign="top">
		<td width="20%"   >{fieldLabel for="customLogo" key="admin.settings.customLogo"}</td>
...
{/if}
	...
	<tr>
		<td width="20%"   ><label for="theme">{translate key="admin.settings.theme"}</label></td>
		<td width="80%" class="value">
	...
	<tr valign="top">
		<td   >{translate key="admin.settings.styleSheet"}</td>
		<td class="value">
...
<table class="data" width="100%">
	<tr valign="top">
		<td width="20%"   >{fieldLabel name="contactName" key="admin.settings.contactName" required="true"}</td>
