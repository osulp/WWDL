...
<div id="navbar">
	<ul class="menu">
		<li id="home"><a href="/">{translate key="navigation.home"}</a></li>
		<li id="about"><a href="/about">{translate key="navigation.about"}</a></li>
		...
		<li id="browse"><a href="/browse">{translate key="navigation.browse"}</a></li>
