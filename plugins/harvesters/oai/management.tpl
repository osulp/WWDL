...
<table class="listing" width="100%">
	...
	<tr valign="top">
		<td width="20%" class="text-right">{translate key="archive.title"}</td>
		<td width="80%" colspan="2" class="value">{$title|escape}</td>
	</tr>
	<tr valign="top">
		<td width="20%" class="text-right">{translate key="archive.recordCount"}</td>
		<td width="80%" colspan="2" class="value">{$numRecords|default:"&mdash;"}</td>
	</tr>
	<tr valign="top">
		<td width="20%" class="text-right">{translate key="archive.lastIndexed"}</td>
...
{if !$archive->getSetting('isStatic')}
	...
	<tr valign="top">
		<td class="text-right"><label for="set">{translate key="plugins.harvesters.oai.archive.form.sets"}</td>
		<td colspan="2" class="value">
			<select class="selectMenu" multiple="multiple" size="25" name="set[]" id="set">
	...
	<tr valign="top">
		<td rowspan="2" class="text-right">{translate key="plugins.harvesters.oai.archive.form.dates"}</td>
